...
import 'package:atmata/presentation/resources/style_manager.dart';
...
ThemeData getApplicationTheme(){
  return ThemeData(
    ...
    ///Text theme
    textTheme: TextTheme(
      displayLarge:getBoldStyle(color: ColorManager.darkGrey,fontSize: FontSize.s28),
      titleMedium: getSemiBoldStyle(color: ColorManager.darkGrey,fontSize: FontSize.s20),
